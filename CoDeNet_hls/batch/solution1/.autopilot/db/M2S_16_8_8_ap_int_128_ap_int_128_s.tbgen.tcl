set moduleName M2S_16_8_8_ap_int_128_ap_int_128_s
set isTopModule 0
...
set C_modelName {M2S<16, 8, 8, ap_int<128>, ap_int<128> >}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 128 regular {axi_master 0}  }
	{ s_mem int 128 regular {fifo 1 volatile }  }
	{ fmap int 64 regular {fifo 0}  }
	{ REP int 29 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY"} , 
 	{ "Name" : "s_mem", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "fmap", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "REP", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ s_mem_din sc_out sc_lv 128 signal 1 } 
	{ s_mem_full_n sc_in sc_logic 1 signal 1 } 
	{ s_mem_write sc_out sc_logic 1 signal 1 } 
	{ fmap_dout sc_in sc_lv 64 signal 2 } 
	{ fmap_empty_n sc_in sc_logic 1 signal 2 } 
	{ fmap_read sc_out sc_logic 1 signal 2 } 
	{ REP sc_in sc_lv 29 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_mem_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "s_mem", "role": "din" }} , 
 	...
 	{ "name": "fmap_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "fmap", "role": "dout" }} , 
 	{ "name": "fmap_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fmap", "role": "empty_n" }} , 
 	{ "name": "fmap_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fmap", "role": "read" }} , 
 	{ "name": "REP", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "REP", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "fmap", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "fmap_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "REP", "Type" : "None", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "1"}]}]}
...
set Spec2ImplPortList { 
	...
	s_mem { ap_fifo {  { s_mem_din fifo_data 1 128 }  { s_mem_full_n fifo_status 0 1 }  { s_mem_write fifo_update 1 1 } } }
	fmap { ap_fifo {  { fmap_dout fifo_data 0 64 }  { fmap_empty_n fifo_status 0 1 }  { fmap_read fifo_update 1 1 } } }
	REP { ap_none {  { REP in_data 0 29 } } }
}
