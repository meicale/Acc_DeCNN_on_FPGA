...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s_mem \
    op interface \
    ports { s_mem_din { O 128 vector } s_mem_full_n { I 1 bit } s_mem_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_fmap \
    op interface \
    ports { fmap_dout { I 64 vector } fmap_empty_n { I 1 bit } fmap_read { O 1 bit } } \
} "
}
