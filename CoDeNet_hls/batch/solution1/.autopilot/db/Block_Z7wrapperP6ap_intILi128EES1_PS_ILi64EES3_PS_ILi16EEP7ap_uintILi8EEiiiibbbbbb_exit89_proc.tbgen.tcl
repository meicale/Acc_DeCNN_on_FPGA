set moduleName Block_Z7wrapperP6ap_intILi128EES1_PS_ILi64EES3_PS_ILi16EEP7ap_uintILi8EEiiiibbbbbb_exit89_proc
set isTopModule 0
...
set C_modelName {Block__Z7wrapperP6ap_intILi128EES1_PS_ILi64EES3_PS_ILi16EEP7ap_uintILi8EEiiiibbbbbb.exit89_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ batch int 32 regular {fifo 0}  }
	{ OC int 32 regular {fifo 0}  }
	{ CONV_D_loc int 32 regular {fifo 0}  }
	{ select_ln169_loc_out int 29 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "batch", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "select_ln169_loc_out", "interface" : "fifo", "bitwidth" : 29, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ batch_dout sc_in sc_lv 32 signal 0 } 
	{ batch_empty_n sc_in sc_logic 1 signal 0 } 
	{ batch_read sc_out sc_logic 1 signal 0 } 
	{ OC_dout sc_in sc_lv 32 signal 1 } 
	{ OC_empty_n sc_in sc_logic 1 signal 1 } 
	{ OC_read sc_out sc_logic 1 signal 1 } 
	{ CONV_D_loc_dout sc_in sc_lv 32 signal 2 } 
	{ CONV_D_loc_empty_n sc_in sc_logic 1 signal 2 } 
	{ CONV_D_loc_read sc_out sc_logic 1 signal 2 } 
	{ select_ln169_loc_out_din sc_out sc_lv 29 signal 3 } 
	{ select_ln169_loc_out_full_n sc_in sc_logic 1 signal 3 } 
	{ select_ln169_loc_out_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln169_loc_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "select_ln169_loc_out", "role": "din" }} , 
 	{ "name": "select_ln169_loc_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "select_ln169_loc_out", "role": "full_n" }} , 
 	{ "name": "select_ln169_loc_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "select_ln169_loc_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "OC", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
			...
			{"Name" : "select_ln169_loc_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "8", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "select_ln169_loc_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_5_1_U896", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_5_1_U897", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_5_1_U898", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	select_ln169_loc_out { ap_fifo {  { select_ln169_loc_out_din fifo_data 1 29 }  { select_ln169_loc_out_full_n fifo_status 0 1 }  { select_ln169_loc_out_write fifo_update 1 1 } } }
}
