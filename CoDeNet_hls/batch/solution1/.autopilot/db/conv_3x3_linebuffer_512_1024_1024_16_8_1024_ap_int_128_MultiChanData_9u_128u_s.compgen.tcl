...
set id 671
set name top_mul_32ns_33ns_65_5_1
...
set id 672
set name top_urem_32s_5ns_4_36_seq_1
...
set id 673
set name top_srem_17ns_3ns_2_21_seq_1
...
set id 676
set name top_mul_10s_10s_10_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set id 691
set name top_am_addmul_16ns_5ns_16ns_33_4_1
...
set out_width 33
set exp (i0+i1)*i2
set arg_lists {i0 {16 0 +} i1 {5 0 +} s {17 0 +} i2 {16 0 +} p {33 0 +} c_expval {c} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 698
set hasByteEnable 0
set MemName top_conv_3x3_linebuffer_512_1024_1024_16_8_1024_ap_int_128_MultiChanData_9u_128u_bkb
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_f1 \
    op interface \
    ports { f1_dout { I 128 vector } f1_empty_n { I 1 bit } f1_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_offset_s \
    op interface \
    ports { offset_s_dout { I 8 vector } offset_s_empty_n { I 1 bit } offset_s_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_in_layer \
    op interface \
    ports { in_layer_din { O 1152 vector } in_layer_full_n { I 1 bit } in_layer_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_D_V_loc_out \
    op interface \
    ports { D_V_loc_out_din { O 16 vector } D_V_loc_out_full_n { I 1 bit } D_V_loc_out_write { O 1 bit } } \
} "
}
